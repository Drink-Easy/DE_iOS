...
class WishListEntireReviewViewController: UIViewController {
...
extension WishListEntireReviewViewController: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
